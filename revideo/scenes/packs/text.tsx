...
export function* runText(view: any, template: string) {
  switch (template) {
    case "text-underline": {
      ...
      const title = str("text", "This policy changed everything");
      const subtitle = str("subtitle", "Classic explainer move — draw a line under the key phrase.");
      const body = str("text", "This policy changed everything");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "TEXT");
    ...
    case "text-marker": {
      const accent = str("accent", "#f0d35a");
      const bg = str("bg", "#0a0c12");
      const title = str("text", "The real cost was hidden in the fine print");
      const subtitle = str("subtitle", "Yellow-marker style fill behind the words you choose.");
      const body = str("text", "The real cost was hidden in the fine print");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "TEXT");
      yield* playStyle(view, "chart", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "text-both": {
      ...
      const bg = str("bg", "#0a0c12");
      const title = str("text", "Nobody asked for this trade-off");
      const subtitle = str("subtitle", "Combine marker fill and animated underline for emphasis.");
      const body = str("text", "Nobody asked for this trade-off");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "TEXT");
      yield* playStyle(view, "chart", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "headline-slam": {
      const accent = str("accent", "#d8a11a");
      const bg = str("bg", "#0a0c12");
      const title = str("headline", "The deal nobody voted for");
      const subtitle = str("subtitle", "Bold news-style title with highlight control.");
      const body = str("text", "The deal nobody voted for");
      const value = str("value", "42");
    ...
    case "quote-callout": {
      const accent = str("accent", "#d8a11a");
      const bg = str("bg", "#0a0c12");
      const title = str("title", "Quote callout");
      const subtitle = str("attribution", "— Editorial board");
      const body = str("quote", "Democracy dies in darkness");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "TEXT");
