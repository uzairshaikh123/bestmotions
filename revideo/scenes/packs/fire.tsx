...
export function* runFire(view: any, template: string) {
  switch (template) {
    case "fire-campfire": {
      const accent = str("accent", "#ff6a00");
      const bg = str("bg", "#07040a");
      const title = str("title", "CAMPFIRE");
      const subtitle = str("subtitle", "Stay close to the warmth");
      const body = str("text", "CAMPFIRE");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
    ...
    case "fire-inferno": {
      const accent = str("accent", "#ff3b00");
      const bg = str("bg", "#0a0202");
      const title = str("title", "INFERNO");
      const subtitle = str("subtitle", "Full-screen wall of fire with title burn-in.");
      const body = str("text", "INFERNO");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-text-burn": {
      const accent = str("accent", "#ff6a00");
      const bg = str("bg", "#08040a");
      const title = str("text", "ON FIRE");
      const subtitle = str("subtitle", "Letters rise through flame glow with ground fire.");
      const body = str("text", "ON FIRE");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-match": {
      const accent = str("accent", "#ff7a18");
      const bg = str("bg", "#060308");
      const title = str("label", "It only takes a spark");
      const subtitle = str("subtitle", "Match slides in, tip sparks, flame blooms.");
      const body = str("text", "It only takes a spark");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-embers": {
      const accent = str("accent", "#ff9f43");
      const bg = str("bg", "#08040a");
      const title = str("title", "Embers");
      const subtitle = str("subtitle", "Field of rising or falling sparks.");
      const body = str("text", "Embers");
      const value = str("count", "48");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
        category: "fire",
    ...
    case "fire-ring": {
      const accent = str("accent", "#ff5a00");
      const bg = str("bg", "#050208");
      const title = str("title", "ENTER");
      const subtitle = str("subtitle", "Through the flames");
      const body = str("text", "ENTER");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-candle": {
      const accent = str("accent", "#ffb347");
      const bg = str("bg", "#06040a");
      const title = str("title", "A single flame");
      const subtitle = str("subtitle", "Is enough to start");
      const body = str("text", "A single flame");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-explosion": {
      const accent = str("accent", "#ff3b00");
      const bg = str("bg", "#050000");
      const title = str("title", "BOOM");
      const subtitle = str("subtitle", "Radial blast with shockwave and sparks.");
      const body = str("text", "BOOM");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
    ...
    case "fire-heat-haze": {
      ...
      const title = str("title", "HEAT WARNING");
      const subtitle = str("subtitle", "Temperatures rising");
      const body = str("text", "HEAT WARNING");
      const value = str("value", "42");
      const eyebrow = str("eyebrow", "FIRE");
      yield* playStyle(view, "fire", {
        title, subtitle, body, value, eyebrow, accent, bg,
